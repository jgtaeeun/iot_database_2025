...
FROM ONLINE_SALE 
UNION ALL SELECT OFFLINE_SALE_ID,SALES_DATE, PRODUCT_ID, NULL, SALES_AMOUNT FROM OFFLINE_SALE) AS T
...
UNION ALL SELECT OFFLINE_SALE_ID,SALES_DATE, PRODUCT_ID, NULL, SALES_AMOUNT FROM OFFLINE_SALE 
WHERE MONTH(SALES_DATE)=03   AND YEAR(SALES_DATE) =2022
ORDER BY SALES_DATE , PRODUCT_ID, USER_ID;