...
ALTER TABLE Charts
ADD FOREIGN KEY R_8 (treat_id, doc_id, pat_id) REFERENCES Treatments (treat_id, doc_id, pat_id);

ALTER TABLE Charts
ADD FOREIGN KEY R_9 (nur_id) REFERENCES Nurses (nur_id);

ALTER TABLE Patients
ADD FOREIGN KEY R_2 (doc_id) REFERENCES Doctors (doc_id);

ALTER TABLE Patients
ADD FOREIGN KEY R_3 (nur_id) REFERENCES Nurses (nur_id);

ALTER TABLE Treatments
ADD FOREIGN KEY R_4 (doc_id) REFERENCES Doctors (doc_id);

ALTER TABLE Treatments
ADD FOREIGN KEY R_6 (pat_id) REFERENCES Patients (pat_id);
